...
import { socket } from "components/ChatScreen";
...
export default function Home({ isConnected }) {
    ...
    useEffect(() => {
        if (isConnected) toast({ type: "success", message: "Connected with Database!" });
        else toast({ type: "error", message: "Failed to connect with Database!" });
    }, [isConnected]);
